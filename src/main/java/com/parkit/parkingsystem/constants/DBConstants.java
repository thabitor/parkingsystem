...
public class DBConstants {
    ...
    public static final String UPDATE_RECURRENT= "update ticket set RECURRENT = ? WHERE ID = ?";
    ...
    public static final String UPDATE_TICKET = "update ticket set PRICE=?, OUT_TIME=?, RECURRENT=? WHERE ID=?";
